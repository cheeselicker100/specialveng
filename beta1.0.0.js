...
games.setAttribute("onclick", "javascript:(function () {var script=document.createElement('script');script.src='https://cdn.jsdelivr.net/gh/cheeselicker100/bkmrklt@main/gameshub.js';document.body.appendChild(script);avoclosedevtools()}())")
games.setAttribute("class", "obtn")
games.innerText = "Game Hub (WIP)"
...
var dwnl = document.createElement("button")
